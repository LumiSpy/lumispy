...
========================
In this example, we will show how to create custom components.
...
# %%
# .. [#f1] To learn more about creating custom components, check out the
#    `Hyperspy documentation <HS_create_components_>`__.
